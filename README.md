...
밤에는 마피아 팀끼리만 소통할 수 있으며, 죽은 플레이어들은 그들만의 채팅방을 가집니다.

**특징:**

- **밤 채팅**: 마피아, 접선한 스파이/마담 전용 채널
- **유령 채팅**: 사망자 전용 대화 (영매 청취 가능)
- **채팅 제한**: 밤 시간 일반 시민 채팅 금지

### 10. 사운드 시스템

게임의 긴장감을 더해주는 배경음악과 효과음

**특징:**

- **동적 BGM**: 낮, 밤, 투표 등 단계별 음악 전환
- **효과음**: 직업 배정, 타이머, 결과 발표 시 SFX
